      ...
      <div className="absolute bottom-[5%] p-4 w-full flex gap-5 md:gap-20 items-center justify-center">
        ...
        {isGamerMode && (
          <div className="bg-black bg-opacity-30 rounded relative w-2/3">
            <p className="text-center p-1">Season: {currentEpisode.season}</p>
            <div
            ...
            >
              {tvShowData.episodes.map((episode) => (
                <div
                  ...
                  className={`inline-block w-64 p-2 rounded-lg mr-4 hover:cursor-pointer transition-all duration-300 hover:brightness-125 ${
